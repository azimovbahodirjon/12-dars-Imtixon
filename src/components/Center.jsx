...
function Center() {
  ...
  const varients = {
    open: { opacity: 1, x: -20, transition },
    close: { opacity: 0, x: -100, transition },
  };

  return (
    <div>
      <div className="dark:bg-[#141625] scrollbar-hide duration-300 min-h-screen bg-[#f8f8fb] py-[34px] px-2 md:px-8 lg:px-12 lg:py-[72px] relative">
        <motion.div
            ...
            <div className="flex items-center">
              ...
              {isDropdown && (
                <motion.div
                  ...
                  className="absolute top-[160px] lg:top-[120px] w-40 bg-white dark:bg-[#1E2139] dark:text-white px-6 py-4 flex flex-col shadow-2xl rounded-xl space-y-2"
                >
                  {filter.map((item, i) => (
                    <div
                      key={i}
